...
rootProject.name = "koog-test-android-app"
...
includeBuild("../../") {
    dependencySubstitution {
        ...
        substitute(module("ai.koog:agents-features-snapshot")).using(project(":agents:agents-features:agents-features-snapshot"))
        ...
        substitute(module("ai.koog:prompt-executor-litert")).using(project(":prompt:prompt-executor:prompt-executor-litert"))
    }
}
