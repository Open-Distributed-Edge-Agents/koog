...
plugins {
    alias(libs.plugins.android.library)      // Use alias from root libs.versions.toml
    id("ai.kotlin.multiplatform")
    alias(libs.plugins.kotlinSerialization)  // Use alias from root libs.versions.toml
}
